//! RST UDP obfs wrapper for quinn (same pattern as RSQ).

use super::obfs::RstObfs;
...
impl Debug for ObfsUdpSocket {
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        f.debug_struct("RstObfsUdpSocket").finish_non_exhaustive()
    }
}
...
impl Debug for ObfsUdpPoller {
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        f.debug_struct("RstObfsUdpPoller").finish_non_exhaustive()
    }
}
