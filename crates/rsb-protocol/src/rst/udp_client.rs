...
pub fn rst_udp_socket(conn: Arc<Connection>, session_id: u32) -> ProxyUdpSocket {
    ...
    ProxyUdpSocket::from_io(Arc::new(RstUdpIo {
        conn,
        session_id,
...
impl ProxyUdpIo for RstUdpIo {
    ...
    async fn recv_from(&self, buf: &mut [u8]) -> std::io::Result<(usize, SocketAddr)> {
        ...
        let (payload, addr) = guard
            .recv()
            .await
            .ok_or_else(|| std::io::Error::new(std::io::ErrorKind::BrokenPipe, "rst udp closed"))?;
